...
shipSpeedInMetersPerSecond = {'name': 'shipSpeedInMetersPerSecond',
                              ...
                              'inherit': True,
                              'units': 'm/s',
                              'dwc: measurementType': 'Ship speed',
                              'dwciri: measurementType': '',
                              'dwc: measurementUnit': 'Metres per second',
                              'dwciri: measurementUnit': 'http://vocab.nerc.ac.uk/collection/P06/current/UVAA/',
                              'valid': {
                                  'validate': 'decimal',
                                  'criteria': '>=',
                                  'value': 0,
...
bottomDepthInMeters = {'name': 'bottomDepthInMeters',
                       ...
                       'dwc: measurementType': 'Sea-floor depth (below instantaneous sea level) {bathymetric depth} in the water body by echo sounder',
                       'dwciri: measurementType': 'http://vocab.nerc.ac.uk/collection/P01/current/MBANZZ01/',
                       'dwc: measurementUnit': 'Metres',
                       'dwciri: measurementUnit': 'http://vocab.nerc.ac.uk/collection/P06/current/ULAA/',
                       'valid': {
                           'validate': 'decimal',
                           'criteria': '>=',
                           'value': 0,
...
sedimentCoreLengthInMeters = {'name': 'sedimentCoreLengthInMeters',
                              ...
                              'units': 'm',
                              'dwc: measurementType': 'Sediment core length',
                              'dwciri: measurementType': '',
                              'dwc: measurementUnit': 'Metres',
                              'dwciri: measurementUnit': 'http://vocab.nerc.ac.uk/collection/P06/current/ULAA/',
                              'valid': {
...
sedimentCoreMaximumDepthInCentiMeters = {'name': 'sedimentCoreMaximumDepthInCentiMeters',
                                         ...
                                         'units': 'cm',
                                         'dwc: measurementType': 'Sediment core maximum depth',
                                         'dwciri: measurementType': '',
                                         'dwc: measurementUnit': 'Centimetres',
                                         'dwciri: measurementUnit': 'http://vocab.nerc.ac.uk/collection/P06/current/ULCM/',
                                         'valid': {
                                             'validate': 'decimal',
                                             'criteria': 'between',
                                             'minimum': 0,
...
sedimentCoreMinimumDepthInCentiMeters = {'name': 'sedimentCoreMinimumDepthInCentiMeters',
                                         ...
                                         'units': 'cm',
                                         'dwc: measurementType': 'Sediment core minimum depth',
                                         'dwciri: measurementType': '',
                                         'dwc: measurementUnit': 'Centimetres',
                                         'dwciri: measurementUnit': 'http://vocab.nerc.ac.uk/collection/P06/current/ULCM/',
                                         'valid': {
...
storageTemp = {'name': 'storageTemp',
               ...
               #'dwc: measurementType': '',
               #'dwciri: measurementType': '',
               #'dwc: measurementUnit': 'Degrees Celsius',
               #'dwciri: measurementUnit': 'http://vocab.nerc.ac.uk/collection/P06/current/UPAA/',
               'valid': {
                   'validate': 'list',
                   'source': [
                       'neg 196 C (LN)',
...
incubationTemperatureInCelsius = {'name': 'incubationTemperatureInCelsius',
        ...
        'units': 'Celsius',
        'dwc: measurementType': 'Incubation temperature',
        'dwciri: measurementType': '',
        'dwc: measurementUnit': 'Degrees Celsius',
        'dwciri: measurementUnit': 'http://vocab.nerc.ac.uk/collection/P06/current/UPAA/',
        'valid': {
...
fixative = {'name': 'fixative',
        'disp_name': 'Fixative',
        'dwc: measurementType': 'Fixative',
        'dwciri: measurementType': '',
        'dwc: measurementUnit': 'NA',
        'dwciri: measurementUnit': 'http://vocab.nerc.ac.uk/collection/P06/current/XXXX/',
            'valid': {
                'validate': 'any',
...
dilution_factor = {'name': 'dilution_factor',
                   ...
                   'width': 20,
                   'dwc: measurementType': 'Dilution factor',
                   'dwciri: measurementType': '',
                   'dwc: measurementUnit': 'NA',
                   'dwciri: measurementUnit': 'http://vocab.nerc.ac.uk/collection/P06/current/XXXX/',
                   'valid': {
...
filteredVolumeInMilliliters = {'name': 'filteredVolumeInMilliliters',
                               ...
                               'dwc: measurementType': 'Filtered volume',
                               'dwciri: measurementType': '',
                               'dwc: measurementUnit': 'Millilitres',
                               'dwciri: measurementUnit': 'http://vocab.nerc.ac.uk/collection/P06/current/VVML/',
                               'valid': {
                                   'validate': 'decimal',
                                   'criteria': '>',
                                   'value': 0,
...
methanol_vol = {'name': 'methanol_vol',
                ...
                'units': 'mL',
                'dwc: measurementType': 'Methanol volume',
                'dwciri: measurementType': '',
                'dwc: measurementUnit': 'Millilitres',
                'dwciri: measurementUnit': 'http://vocab.nerc.ac.uk/collection/P06/current/VVML/',
                'valid': {
...
sampleVolumeInMilliliters = {'name': 'sampleVolumeInMilliliters',
                             ...
                             'units': 'mL',
                             'dwc: measurementType': 'Sample volume',
                             'dwciri: measurementType': '',
                             'dwc: measurementUnit': 'Millilitres',
                             'dwciri: measurementUnit': 'http://vocab.nerc.ac.uk/collection/P06/current/VVML/',
                             'valid': {
...
subsample_vol = {'name': 'subsample_vol',
                 ...
                 'units': 'mL',
                 'dwc: measurementType': 'Subsample volume',
                 'dwciri: measurementType': '',
                 'dwc: measurementUnit': 'Millilitres',
                 'dwciri: measurementUnit': 'http://vocab.nerc.ac.uk/collection/P06/current/VVML/',
                 'valid': {
...
serialNumber = {'name': 'serialNumber',
                ...
                'dwc: measurementType': 'Serial number of instrument',
                'dwciri: measurementType': 'http://vocab.nerc.ac.uk/collection/P01/current/SERNUMZZ/',
                'dwc: measurementUnit': 'NA',
                'dwciri: measurementUnit': 'http://vocab.nerc.ac.uk/collection/P06/current/XXXX/',
                'valid': {
                    'validate': 'any',
...
tissueType = {'name': 'tissueType',
              ...
              'dwc: measurementType': 'tissue',
              'dwciri: measurementType': 'http://vocab.nerc.ac.uk/collection/S12/current/S1225/',
              'dwc: measurementUnit': 'NA',
              'dwciri: measurementUnit': 'http://vocab.nerc.ac.uk/collection/P06/current/XXXX/',
              'valid': {
                  'validate': 'any',
...
seaIceCoreLengthInMeters = {'name': 'seaIceCoreLengthInMeters',
                            ...
                            'units': 'cm',
                            'dwc: measurementType': 'Sea ice core length',
                            'dwciri: measurementType': '',
                            'dwc: measurementUnit': 'Centimetres',
                            'dwciri: measurementUnit': 'http://vocab.nerc.ac.uk/collection/P06/current/ULCM/',
                            'valid': {
...
seaIceCoreMaximumDepthInCentiMeters = {'name': 'seaIceCoreMaximumDepthInCentiMeters',
                                         ...
                                         'units': 'cm',
                                         'dwc: measurementType': 'Sea ice core maximum depth',
                                         'dwciri: measurementType': '',
                                         'dwc: measurementUnit': 'Centimetres',
                                         'dwciri: measurementUnit': 'http://vocab.nerc.ac.uk/collection/P06/current/ULCM/',
                                         'valid': {
...
seaIceCoreMinimumDepthInCentiMeters = {'name': 'seaIceCoreMinimumDepthInCentiMeters',
                                         ...
                                         'units': 'cm',
                                         'dwc: measurementType': 'Sea ice core minimum depth',
                                         'dwciri: measurementType': '',
                                         'dwc: measurementUnit': 'Centimetres',
                                         'dwciri: measurementUnit': 'http://vocab.nerc.ac.uk/collection/P06/current/ULCM/',
                                         'valid': {
...
seaIceThicknessInMeters = {'name': 'seaIceThicknessInMeters',
                           ...
                           'units': 'cm',
                           'dwc: measurementType': 'sea_ice_thickness',
                           'dwciri: measurementType': 'http://vocab.nerc.ac.uk/collection/P07/current/CFSN0369/',
                           'dwc: measurementUnit': 'Centimetres',
                           'dwciri: measurementUnit': 'http://vocab.nerc.ac.uk/collection/P06/current/ULCM/',
                           'valid': {
                               'validate': 'decimal',
...
seaIceFreeboardInMeters = {'name': 'seaIceFreeboardInMeters',
                           ...
                           'units': 'cm',
                           'dwc: measurementType': 'sea_ice_freeboard',
                           'dwciri: measurementType': 'http://vocab.nerc.ac.uk/collection/P07/current/CFSN0365/',
                           'dwc: measurementUnit': 'Centimetres',
                           'dwciri: measurementUnit': 'http://vocab.nerc.ac.uk/collection/P06/current/ULCM/',
                           'valid': {
                               'validate': 'decimal',
...
seaIceCoreTemperatureInCelsius = {'name': 'seaIceCoreTemperatureInCelsius',
                                       ...
                                       'units': 'Celsius',
                                       'dwc: measurementType': 'Sea ice core temperature',
                                       'dwciri: measurementType': '',
                                       'dwc: measurementUnit': 'Degrees Celsius',
                                       'dwciri: measurementUnit': 'http://vocab.nerc.ac.uk/collection/P06/current/UPAA/',
                                       'valid': {
...
seaIceMeltpondTemperatureInCelsius = {'name': 'seaIceMeltpondTemperatureInCelsius',
                                       ...
                                       'units': 'Celsius',
                                       'dwc: measurementType': 'Sea ice meltpond temperature',
                                       'dwciri: measurementType': '',
                                       'dwc: measurementUnit': 'Degrees Celsius',
                                       'dwciri: measurementUnit': 'http://vocab.nerc.ac.uk/collection/P06/current/UPAA/',
                                       'valid': {
...
seaIceMeltpondSalinity = {'name': 'seaIceMeltpondSalinity',
                          ...
                          'units': '1e-3',
                          'dwc: measurementType': 'Sea ice meltpond salinity',
                          'dwciri: measurementType': '',
                          'dwc: measurementUnit': 'Parts per thousand',
                          'dwciri: measurementUnit': 'http://vocab.nerc.ac.uk/collection/P06/current/UPPT/',
                          'valid': {
                              'validate': 'decimal',
                              'criteria': '>=',
                              'value': 0,
...
seaWaterTemperatueInCelsius = {'name': 'seaWaterTemperatueInCelsius',
                               ...
                               'dwc: measurementType': 'sea_water_temperature',
                               'dwciri: measurementType': 'http://vocab.nerc.ac.uk/collection/P07/current/CFSN0335/',
                               'dwc: measurementUnit': 'Degrees Celsius',
                               'dwciri: measurementUnit': 'http://vocab.nerc.ac.uk/collection/P06/current/UPAA/',
                               'valid': {
                                   'validate': 'decimal',
...
seaWaterPracticalSalinity = {'name': 'seaWaterPracticalSalinity',
                             ...
                             'dwc: measurementType': 'sea_water_practical_salinity',
                             'dwciri: measurementType': 'http://vocab.nerc.ac.uk/collection/P07/current/IADIHDIJ/',
                             'dwc: measurementUnit': 'NA',
                             'dwciri: measurementUnit': 'http://vocab.nerc.ac.uk/collection/P06/current/XXXX/',
                             'valid': {
                                 'validate': 'decimal',
...
seaWaterAbsoluteSalinity = {'name': 'seaWaterAbsoluteSalinity',
                            ...
                            'dwc: measurementType': 'sea_water_absolute_salinity',
                            'dwciri: measurementType': 'http://vocab.nerc.ac.uk/collection/P07/current/JIBGDIEJ/',
                            'dwc: measurementUnit': 'Grams per kilogram',
                            'dwciri: measurementUnit': 'http://vocab.nerc.ac.uk/collection/P06/current/UGKG/',
                            'valid': {
                                'validate': 'decimal',
                                'criteria': '>=',
                                'value': 0,
...
seaWaterElectricalConductivity = {'name': 'seaWaterElectricalConductivity',
                                  ...
                                  'dwc: measurementType': 'sea_water_electrical_conductivity',
                                  'dwciri: measurementType': 'http://vocab.nerc.ac.uk/collection/P07/current/CFSN0394/',
                                  'dwc: measurementUnit': 'Siemens per metre',
                                  'dwciri: measurementUnit': 'http://vocab.nerc.ac.uk/collection/P06/current/UECA/',
                                  'valid': {
                                      'validate': 'decimal',
                                      'criteria': '>=',
                                      'value': 0,
...
seaWaterPressure = {'name': 'seaWaterPressure',
                    ...
                    'dwc: measurementType': 'sea_water_pressure',
                    'dwciri: measurementType': 'http://vocab.nerc.ac.uk/collection/P07/current/CFSN0330/',
                    'dwc: measurementUnit': 'Decibars',
                    'dwciri: measurementUnit': 'http://vocab.nerc.ac.uk/collection/P06/current/UPDB/',
                    'valid': {
                        'validate': 'decimal',
                        'criteria': '>',
                        'value': 0,
...
seaWaterChlorophyllA = {'name': 'seaWaterChlorophyllA',
                        ...
                        'units': 'mg m-3',
                        'dwc: measurementType': 'mass_concentration_of_chlorophyll_a_in_sea_water',
                        'dwciri: measurementType': 'http://vocab.nerc.ac.uk/collection/P07/current/CF14N7/',
                        'dwc: measurementUnit': 'Milligrams per square metre',
                        'dwciri: measurementUnit': 'http://vocab.nerc.ac.uk/collection/P06/current/UMMS/',
                        'valid': {
                            'validate': 'decimal',
                            'criteria': '>=',
                            'value': 0,
...
seaWaterPhaeopigment = {'name': 'seaWaterPhaeopigment',
                        ...
                        'units': 'mg m-3',
                        'dwc: measurementType': 'mass_concentration_of_phaeopigment_in_sea_water',
                        'dwciri: measurementType': '',
                        'dwc: measurementUnit': 'Milligrams per square metre',
                        'dwciri: measurementUnit': 'http://vocab.nerc.ac.uk/collection/P06/current/UMMS/',
                        'valid': {
...
seaIceChlorophyllA = {'name': 'seaIceChlorophyllA',
                      ...
                      'units': 'mg m-3',
                      'dwc: measurementType': 'mass_concentration_of_chlorophyll_a_in_sea_ice',
                      'dwciri: measurementType': '',
                      'dwc: measurementUnit': 'Milligrams per square metre',
                      'dwciri: measurementUnit': 'http://vocab.nerc.ac.uk/collection/P06/current/UMMS/',
                      'valid': {
...
seaIcePhaeopigment = {'name': 'seaIcePhaeopigment',
                      ...
                      'units': 'mg m-3',
                      'dwc: measurementType': 'mass_concentration_of_phaeopigment_in_sea_ice',
                      'dwciri: measurementType': '',
                      'dwc: measurementUnit': 'Milligrams per square metre',
                      'dwciri: measurementUnit': 'http://vocab.nerc.ac.uk/collection/P06/current/UMMS/',
                      'valid': {
...
sedimentChlorophyllA = {'name': 'sedimentChlorophyllA',
                        ...
                        'units': 'mg m-3',
                        'dwc: measurementType': 'Chlorophyll-a in sediment',
                        'dwciri: measurementType': 'http://vocab.nerc.ac.uk/collection/P09/current/CHAS/',
                        'dwc: measurementUnit': 'Milligrams per square metre',
                        'dwciri: measurementUnit': 'http://vocab.nerc.ac.uk/collection/P06/current/UMMS/',
                        'valid': {
                            'validate': 'decimal',
...
sedimentPhaeopigment = {'name': 'sedimentPhaeopigment',
                        ...
                        'units': 'mg m-3',
                        'dwc: measurementType': 'mass_concentration_of_phaeopigment_in_sediment',
                        'dwciri: measurementType': '',
                        'dwc: measurementUnit': 'Milligrams per square metre',
                        'dwciri: measurementUnit': 'http://vocab.nerc.ac.uk/collection/P06/current/UMMS/',
                        'valid': {
...
sedimentPH = {'name': 'sedimentPH',
              ...
              'units': '1',
              'dwc: measurementType': 'pH in the sediment',
              'dwciri: measurementType': 'http://vocab.nerc.ac.uk/collection/P35/current/EPC00136/',
              'dwc: measurementUnit': 'NA',
              'dwciri: measurementUnit': 'http://vocab.nerc.ac.uk/collection/P06/current/XXXX/',
              'valid': {
                  'validate': 'decimal',
...
sedimentTOC = {'name': 'sedimentTOC',
               ...
               'units': 'mg L-1',
               'dwc: measurementType': 'SEDIMENT TOTAL ORGANIC CARBON',
               'dwciri: measurementType': 'http://vocab.nerc.ac.uk/collection/P09/current/TOCS/',
               'dwc: measurementUnit': 'Milligrams per litre',
               'dwciri: measurementUnit': 'http://vocab.nerc.ac.uk/collection/P06/current/UMGL/',
               'valid': {
                   'validate': 'decimal',
                   'criteria': '>=',
                   'value': 0,
...
sedimentTN = {'name': 'sedimentTN',
              ...
              'units': 'mg L-1',
              'dwc: measurementType': 'SEDIMENT TOTAL NITROGEN',
              'dwciri: measurementType': 'http://vocab.nerc.ac.uk/collection/P09/current/TNNS/',
              'dwc: measurementUnit': 'Milligrams per litre',
              'dwciri: measurementUnit': 'http://vocab.nerc.ac.uk/collection/P06/current/UMGL/',
              'valid': {
                  'validate': 'decimal',
...
benthicRespiration = {'name': 'benthicRespiration',
                      ...
                      'units': 'mmol m-2',
                      'dwc: measurementType': 'Benthic respiration of oxygen',
                      'dwciri: measurementType': '',
                      'dwc: measurementUnit': 'Millimoles per square metre',
                      'dwciri: measurementUnit': 'http://vocab.nerc.ac.uk/collection/P06/current/MMSM/',
                      'valid': {
                          'validate': 'decimal',
                          'criteria': '>=',
                          'value': 0,
...
seaWaterTotalDIC = {'name': 'seaWaterTotalDIC',
                    ...
                    'units': 'umol kg-1',
                    'dwc: measurementType': 'mole_concentration_of_dissolved_inorganic_carbon_in_sea_water',
                    'dwciri: measurementType': 'http://vocab.nerc.ac.uk/collection/P07/current/CF14N27/',
                    'dwc: measurementUnit': 'Micromoles per kilogram',
                    'dwciri: measurementUnit': 'http://vocab.nerc.ac.uk/collection/P06/current/KGUM/',
...
seaIceTotalDIC = {'name': 'seaIceTotalDIC',
                  ...
                  'units': 'umol kg-1',
                  'dwc: measurementType': 'mole_concentration_of_dissolved_inorganic_carbon_in_sea_ice',
                  'dwciri: measurementType': '',
                  'dwc: measurementUnit': 'Micromoles per kilogram',
                  'dwciri: measurementUnit': 'http://vocab.nerc.ac.uk/collection/P06/current/KGUM/',
                  'valid': {
...
seaWaterDeltaO18 = {'name': 'seaWaterDeltaO18',
                    ...
                    'units': '1e-3',
                    'dwc: measurementType': 'ISOTOPIC RATIO O18/O16',
                    'dwciri: measurementType': 'http://vocab.nerc.ac.uk/collection/P09/current/OXIR/',
                    'dwc: measurementUnit': 'Parts per thousand',
                    'dwciri: measurementUnit': 'http://vocab.nerc.ac.uk/collection/P06/current/UPPT/',
                    'valid': {
                        'validate': 'decimal',
...
seaWaterPH = {'name': 'seaWaterPH',
              ...
              'dwc: measurementType': 'sea_water_ph_reported_on_total_scale',
              'dwciri: measurementType': 'http://vocab.nerc.ac.uk/collection/P07/current/CF14N56/',
              'dwc: measurementUnit': 'NA',
              'dwciri: measurementUnit': 'http://vocab.nerc.ac.uk/collection/P06/current/XXXX/',
              'valid': {
                  'validate': 'decimal',
...
seaWaterAlkalinity = {'name': 'seaWaterAlkalinity',
                      ...
                      'units': 'umol kg-1',
                      'dwc: measurementType': 'Total alkalinity per unit mass of the water body',
                      'dwciri: measurementType': 'http://vocab.nerc.ac.uk/collection/P01/current/MDMAP014/',
                      'dwc: measurementUnit': 'Micromoles per kilogram',
                      'dwciri: measurementUnit': 'http://vocab.nerc.ac.uk/collection/P06/current/KGUM/',
                      'valid': {
                          'validate': 'decimal',
...
seaWaterTOC = {'name': 'seaWaterTOC',
               'disp_name': 'TOC (mg/L)',
               'units': 'mg L-1',
               'dwc: measurementType': 'TOTAL ORGANIC CARBON',
               'dwciri: measurementType': 'http://vocab.nerc.ac.uk/collection/P09/current/TOCW/',
               'dwc: measurementUnit': 'Milligrams per litre',
               'dwciri: measurementUnit': 'http://vocab.nerc.ac.uk/collection/P06/current/UMGL/',
               'valid': {
                   'validate': 'decimal',
...
seaWaterPON = {'name': 'seaWaterPON',
               'disp_name': 'PON (ug/L)',
               'units': 'ug L-1',
               'dwc: measurementType': 'Water body particulate nitrogen',
               'dwciri: measurementType': 'http://vocab.nerc.ac.uk/collection/P35/current/EPC00212/',
               'dwc: measurementUnit': 'Micrograms per litre',
               'dwciri: measurementUnit': 'http://vocab.nerc.ac.uk/collection/P06/current/UGPL/',
               'valid': {
                   'validate': 'decimal',
                   'criteria': '>=',
                   'value': 0,
...
seaWaterPOC = {'name': 'seaWaterPOC',
               'disp_name': 'POC (ug/L)',
               'units': 'ug L-1',
               'dwc: measurementType': 'Water body particulate organic carbon {POC}',
               'dwciri: measurementType': 'http://vocab.nerc.ac.uk/collection/P35/current/EPC00157/',
               'dwc: measurementUnit': 'Micrograms per litre',
               'dwciri: measurementUnit': 'http://vocab.nerc.ac.uk/collection/P06/current/UGPL/',
               'valid': {
                   'validate': 'decimal',
...
weightInGrams = {'name': 'weightInGrams',
                 'disp_name': 'Weight (g)',
                 'units': 'g',
                 'dwc: measurementType': 'mass',
                 'dwciri: measurementType': 'http://vocab.nerc.ac.uk/collection/P21/current/MS6179/',
                 'dwc: measurementUnit': 'Grams',
                 'dwciri: measurementUnit': 'http://vocab.nerc.ac.uk/collection/P06/current/UGRM/',
                 'valid': {
                     'validate': 'decimal',
                     'criteria': '>',
                     'value': 0,
...
gonadWeightInGrams = {'name': 'gonadWeightInGrams',
                      ...
                      'units': 'g',
                      'dwc: measurementType': 'Gonad weight',
                      'dwciri: measurementType': '',
                      'dwc: measurementUnit': 'Grams',
                      'dwciri: measurementUnit': 'http://vocab.nerc.ac.uk/collection/P06/current/UGRM/',
                      'valid': {
...
liverWeightInGrams = {'name': 'liverWeightInGrams',
                      ...
                      'units': 'g',
                      'dwc: measurementType': 'Liver weight',
                      'dwciri: measurementType': '',
                      'dwc: measurementUnit': 'Grams',
                      'dwciri: measurementUnit': 'http://vocab.nerc.ac.uk/collection/P06/current/UGRM/',
                      'valid': {
...
somaticWeightInGrams = {'name': 'somaticWeightInGrams',
                        ...
                        'units': 'g',
                        'dwc: measurementType': 'Somatic weight',
                        'dwciri: measurementType': '',
                        'dwc: measurementUnit': 'Grams',
                        'dwciri: measurementUnit': 'http://vocab.nerc.ac.uk/collection/P06/current/UGRM/',
                        'valid': {
...
forkLengthInMeters = {'name': 'forkLengthInMeters',
                      ...
                      'units': 'cm',
                      'dwc: measurementType': 'Fork length',
                      'dwciri: measurementType': '',
                      'dwc: measurementUnit': 'Centimetres',
                      'dwciri: measurementUnit': 'http://vocab.nerc.ac.uk/collection/P06/current/ULCM/',
                      'valid': {
...
totalFishLengthInMeters = {'name': 'totalFishLengthInMeters',
                      ...
                      'units': 'cm',
                      'dwc: measurementType': 'Total fish length',
                      'dwciri: measurementType': '',
                      'dwc: measurementUnit': 'Centimetres',
                      'dwciri: measurementUnit': 'http://vocab.nerc.ac.uk/collection/P06/current/ULCM/',
                      'valid': {
...
maturationStage = {'name': 'maturationStage',
                   ...
                   'units': '1',
                   'dwc: measurementType': 'Maturation stage',
                   'dwciri: measurementType': 'http://vocab.nerc.ac.uk/collection/S11/current/',
                   'dwc: measurementUnit': 'NA',
                   'dwciri: measurementUnit': 'http://vocab.nerc.ac.uk/collection/P06/current/XXXX/',
                   'valid': {
                       'validate': 'decimal',
...
ectoparasites = {'name': 'ectoparasites',
                 ...
                 'units': '1',
                 'dwc: measurementType': 'Ectoparasites',
                 'dwciri: measurementType': '',
                 'dwc: measurementUnit': 'NA',
                 'dwciri: measurementUnit': 'http://vocab.nerc.ac.uk/collection/P06/current/XXXX/',
                 'valid': {
...
endoparasites = {'name': 'endoparasites',
                 ...
                 'units': '1',
                 'dwc: measurementType': 'Endoparasites',
                 'dwciri: measurementType': '',
                 'dwc: measurementUnit': 'NA',
                 'dwciri: measurementUnit': 'http://vocab.nerc.ac.uk/collection/P06/current/XXXX/',
                 'valid': {
